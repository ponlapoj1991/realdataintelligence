<template>
  <div class="aippt-dialog">
    <div class="header">
      ...
      <span class="subtite" v-if="step === 'template'">从下方挑选合适的模板生成PPT，或<span class="local" v-tooltip="'上传 RealPPTX 模板文件'" @click="uploadLocalTemplate()">使用本地模板生成</span></span>
...
.header {
  ...
  .title {
    ...
    font-size: 20px;
    margin-right: 8px;
    color: var(--realpptx-accent, #111827);
  ...
  .subtite {
    ...
    .local {
      color: var(--realpptx-accent, currentColor);
