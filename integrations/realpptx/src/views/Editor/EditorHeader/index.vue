        ...
        <template #content>
          <div class="main-menu">
            <div class="ai-menu" @click="openAIPPTDialog(); mainMenuVisible = false">
              ...
              <div class="aippt-content">
                ...
                <div class="aippt-subtitle">Generate presentation</div>
              </div>
            </div>
          </div>
          <Divider :margin="10" />
          <div class="import-section">
            ...
            <div class="import-grid">
              ...
              <FileInput class="import-block" accept=".pptist,.realpptx" @change="files => {
                importSpecificFile(files)
                mainMenuVisible = false
              }">
                <span class="icon"><IconNotes /></span>
                <span class="label">RealPPTX</span>
          ...
          <PopoverMenuItem class="popover-menu-item" @click="goLink('https://github.com/ponlapoj1991/realdataintelligence/issues')"><IconComment class="icon" /> Feedback</PopoverMenuItem>
          <PopoverMenuItem class="popover-menu-item" @click="goLink('https://github.com/ponlapoj1991/realdataintelligence#readme')"><IconHelpcenter class="icon" /> FAQ</PopoverMenuItem>
          <Divider :margin="10" />
          <div class="statement">RealPPTX Editor</div>
        </template>
...
const requestHostSave = () => {
  window.parent?.postMessage({ source: 'realpptx', type: 'request-save' }, '*')
  mainMenuVisible.value = false
}
</script>
...
.editor-header {
  background-color: var(--realpptx-bg, #ffffff);
  user-select: none;
...
.menu-item {
  ...
  .ai {
    background: none;
    color: var(--realpptx-accent, #374151);
    font-weight: 600;
  }
