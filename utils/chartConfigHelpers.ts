...
const SUPPORT_MATRIX: Record<ChartType, ChartSupports> = {
  ...
  pie:           { dimension: true, stackBy: false, multiSeries: false, measure: true,  bubble: false, scatterXY: false, pie: true,  line: false, area: false, axes: false, legend: true, dataLabels: true, sort: true, categoryFilter: true, categoryConfig: true },
  donut:         { dimension: true, stackBy: false, multiSeries: false, measure: true,  bubble: false, scatterXY: false, pie: true,  line: false, area: false, axes: false, legend: true, dataLabels: true, sort: true, categoryFilter: true, categoryConfig: true },
  scatter:       { dimension: true,  stackBy: false, multiSeries: false, measure: false, bubble: false, scatterXY: true,  pie: false, line: false, area: false, axes: true,  legend: true,  dataLabels: true,  sort: false, categoryFilter: true, categoryConfig: true  },
  bubble:        { dimension: true,  stackBy: false, multiSeries: false, measure: false, bubble: true,  scatterXY: true,  pie: false, line: false, area: false, axes: true,  legend: true,  dataLabels: true,  sort: false, categoryFilter: true, categoryConfig: true  },
  ...
  wordcloud:     { dimension: true, stackBy: false, multiSeries: false, measure: true,  bubble: false, scatterXY: false, pie: false, line: false, area: false, axes: false, legend: false, dataLabels: false, sort: false, categoryFilter: true, categoryConfig: false }
};
