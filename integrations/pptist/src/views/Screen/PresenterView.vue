<template>
  <div class="presenter-view">
    <div class="toolbar">
      ...
      <div class="tool-btn" :class="{ 'active': laserPen }" @click="laserPen = !laserPen"><IconMagic class="tool-icon" /><span>Laser</span></div>
      ...
      <div class="tool-btn" @click="() => fullscreenState ? manualExitFullscreen() : enterFullscreen()">
        ...
        <span>{{ fullscreenState ? 'Exit Full' : 'Full Scr' }}</span>
      </div>
