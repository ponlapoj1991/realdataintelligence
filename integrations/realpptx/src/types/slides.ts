...
export interface ChartOptions {
  ...
  seriesTypes?: ('bar' | 'line' | 'area')[] // combo
  yAxisIndexes?: number[] // combo dual axis mapping
  pointSizes?: number[] // scatter/bubble
  orientation?: 'vertical' | 'horizontal' // bar/column
  barWidth?: number
...
export interface ChartData {
  labels: string[]
  legends: string[]
  series: number[][] // combo/stack/scatter support
  seriesColors?: string[] // per series
  dataColors?: string[] // per data point (single-series)
}
