...
import type { ChartOptions, ChartType } from '@/types/slides'
...
const insertChart = (chart: ChartType, options?: ChartOptions) => {
  createChartElement(chart, { options })
